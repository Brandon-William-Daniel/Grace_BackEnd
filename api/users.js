...
usersRouter.post("/register", async (req, res, next) => {
  ...
  try {
    ...
    //Matt: Make sure to hash the password with bcrypt before creating the user in the DB
...
//Matt: you may want to add requireUser to this, and check that the signed in user is the one
// trying to fetch the orders. Otherwise anybody could see anyone's orders
